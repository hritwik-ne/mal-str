...
# loading v_0.2 dataset
# and appending it to previous dataframe 
...
new_train_df.to_csv('../data/combined/train.csv')
new_valid_df.to_csv('../data/combined/valid.csv')
new_test_df.to_csv('../data/combined/test.csv')